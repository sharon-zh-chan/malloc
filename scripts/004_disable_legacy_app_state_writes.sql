...
revoke execute on function public.replace_workspace_state(jsonb) from anon, authenticated;
revoke execute on function public.delete_workspace() from anon, authenticated;
